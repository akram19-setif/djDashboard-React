...
const Sidebar = () => {
  ...
  return (
    <div className='ml-3 h-screen md:overflow-hidden overflow-scroll md:hover:overflow-auto  pb-60 md:pb-10'>
     {activeMenu && (<>
     ...
     <TooltipComponent content='Menu' position='BottomCenter'>
      ...
      className='text-xl rounded-full mt-4 p-3 hover:bg-light-gray block md:hidden'> 
        <MdOutlineCancel/>
      </button>
      </TooltipComponent>
      </div> 
